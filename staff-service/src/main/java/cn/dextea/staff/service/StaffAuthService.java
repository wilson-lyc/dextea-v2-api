...
public interface StaffAuthService {
     ...
     */
    ApiResponse<StaffLoginResponse> login(LoginStaffRequest request, HttpServletRequest httpServletRequest);
     ...
     * @return 返回修改结果
     */
    ApiResponse<Void> updatePassword(UpdateStaffPasswordRequest request);
}
